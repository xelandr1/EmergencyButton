...
namespace EmergencyButton.Core.Common
{
    ...
    public class SafeCancellationToken
    {
        ...
        /// </summary>
        public CancellationTokenExceptionThrowMode ExceptionThrowMode { get; set; } =
            CancellationTokenExceptionThrowMode.None;
        ...
        public void RegisterCallback(Action action)
        {
            ...
            if (_cancelled) throw new InvalidOperationException("Already cancelled");
        ...
        public void Cancel()
        {
            if (IsStub) throw new InvalidOperationException("Token is SafeCancellationToken.None");
            ...
            {
                _cancelled = true;
                foreach (var callback in _cancellationCallbacks) callback();
